                ...
                <ul class="navbar-nav ms-auto">
                    @guest
                        ...
                        <li class="nav-item me-2">
                            <a class="nav-link btn btn-outline-primary btn-sm" href="{{ route('login') }}">Login</a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="row g-4">
                ...
                <div class="col-6 col-lg-2">
                    ...
                    <ul class="list-unstyled">
                        ...
                        @else
                            <li class="mb-2"><a href="{{ route('account') }}">My Account</a></li>
                            <li class="mb-2"><a href="{{ route('orders') }}">Orders</a></li>
                            <li class="mb-2"><a href="{{ route('cart') }}">Cart</a></li>
                        @endguest
                    </ul>
                </div>
                <div class="col-lg-4">
